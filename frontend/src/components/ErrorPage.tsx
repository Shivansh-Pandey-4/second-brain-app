...
const ErrorPage = () => {
    return (
        <div className="bg-[#2d2d2d] min-h-screen">
            ...
            <p className="text-center max-w-full md:w-2xl text-white pb-10 font-serif text-md md:text-lg px-4 mx-auto ">Oops! It seems like the page you're trying to access doesn't exist. If you <br /> believe there's an issue, feel free to report it, and we'll look into it.</p>
